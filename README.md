...
- On pull requests targeting `master`, CI runs code quality, type checks, smoke tests, and build jobs scoped by changed app folders (plus shared/global build files).
