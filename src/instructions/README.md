...
| ----------------------------------------- | ------------------------------------------- | -------------------------- |
| `summarize-changes/SKILL.md`              | `~/.dawg/skills/summarize-changes/SKILL.md` | Diff-based changes summary |
| `review-changes/SKILL.md`                 | `~/.dawg/skills/review-changes/SKILL.md`    | Self code review           |
| `how-to-test/SKILL.md`                    | `~/.dawg/skills/how-to-test/SKILL.md`       | Manual testing walkthrough |
| `write-tests/SKILL.md`                    | `~/.dawg/skills/write-tests/SKILL.md`       | Test strategy orchestrator |
| `write-unit-tests/SKILL.md`               | `~/.dawg/skills/write-unit-tests/SKILL.md`  | Unit test writing          |
| `write-integration-tests/SKILL.md`        | `~/.dawg/skills/write-integration-tests/SKILL.md` | Integration test writing |
| `write-e2e-tests/SKILL.md`                | `~/.dawg/skills/write-e2e-tests/SKILL.md`   | End-to-end test writing    |
| `explain-like-im-5/SKILL.md`              | `~/.dawg/skills/explain-like-im-5/SKILL.md` | Domain onboarding explainer |
| `address-review-findings/SKILL.md`        | `~/.dawg/skills/address-review-findings/SKILL.md` | Remediate review output |
| `work-on-task/SKILL.md`                   | `~/.dawg/skills/work-on-task/SKILL.md`      | Generic CLI task workflow  |
